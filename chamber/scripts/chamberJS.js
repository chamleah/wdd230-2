if (window.location.pathname === "/wdd230-2/chamber/index.html" || window.location.pathname === "/chamber/index.html") {
    getSpotLightMembers();
    getCopyrightYear();
    getLastModified();
    initBanner();
}
if (window.location.pathname === "/wdd230-2/chamber/directory.html" || window.location.pathname === "/chamber/directory.html") {
    getCopyrightYear();
    getLastModified();
}

if (window.location.pathname === "/wdd230-2/chamber/discover.html" || window.location.pathname === "/chamber/discover.html") {
    getCopyrightYear();
    getLastModified();
    // Call the function to update the page visits counter
    updatePageVisitsCounter();
}
if (window.location.pathname === "/wdd230-2/chamber/join.html" || window.location.pathname === "/chamber/join.html") {
    getCopyrightYear();
    getLastModified();
}
...
async function getSpotLightMembers() {
    const dataURL = "https://chamleah.github.io/wdd230-2/chamber/data/members.json";
    try {
